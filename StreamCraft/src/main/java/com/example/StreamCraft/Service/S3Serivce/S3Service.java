...
import com.example.StreamCraft.Repository.EpisodeRepository.AnimationEpisodeEntityRepository;
import com.example.StreamCraft.Repository.EpisodeRepository.MovieEpisodeRepository;
...
public class S3Service {
    ...
    *  */
    ...
    private void saveEpisodeData(VideoMetadataRequestDto videoMetadataRequestDto, String imageFileUri, MultipartFile subtitle) {
        UploadMainTitleEntity uploadMainTitleEntity = uploadMainTitleRepository.findByTitleContainingAndGenre(videoMetadataRequestDto.getTitle(), videoMetadataRequestDto.getGenre()).get();
